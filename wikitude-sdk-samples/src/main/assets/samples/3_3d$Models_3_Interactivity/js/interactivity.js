...
this.imgButton = new AR.ImageResource("assets/icon3.png");
var pageOneButton1 = this.createWwwButton("http://www.amazon.in/D-Link-DIR-890L-Wireless-Smartbeam-technology/dp/B00PVD81MK", 0.05, {
			offsetX: -0.15,
			offsetY: -0.40,
			zOrder: 1
		});
		this.imgButton = new AR.ImageResource("assets/rupee.png");
        var pageOneButton2 = this.createWwwButton("http://www.jabong.com/breakbounce-Blue-Slim-Fit-Casual-Shirt-1428800.html", 0.05, {
        			offsetX: 0.0,
        			offsetY: 0.15,
        			zOrder: 1
        		});
        		this.imgButton = new AR.ImageResource("assets/rupee.png");
                        var pageOneButton3 = this.createWwwButton("http://www.jabong.com/breakbounce-Blue-Washed-Regular-Fit-Jeans-1324630.html", 0.1, {
                        			offsetX: 0.0,
                        			offsetY: -0.25,
                        			zOrder: 1
                        		});
                        		this.imgButton = new AR.ImageResource("assets/rupee.png");
                                                        var pageOneButton4 = this.createWwwButton("http://www.jabong.com/turtle-Blue-Hat-1732421.html", 0.05, {
                                                        			offsetX: 0.10,
                                                        			offsetY: 0.35,
                                                        			zOrder: 1
                                                        		});
                                      var pageOneButton5 = this.createWwwButton("http://www.flipkart.com/protext-checkered-single-breasted-casual-formal-lounge-wear-party-wedding-men-s-blazer/p/itme85gxyrgdugpb", 0.1, {
                                                                                            			offsetX: -0.60,
                                                                                            			offsetY: 0.10,
                                                                                            			zOrder: 1
                                                                                            		});

        	   var pageOneButton6 = this.createWwwButton("http://www.jabong.com/tossido-Black-Tie-2086333.html?pos=111", 0.05, {
                                                                                                        			offsetX: -0.45,
                                                                                                        			offsetY: 0.0,
                                                                                                        			zOrder: 1
                                                                                                        		});
		...
		*/
		var trackable = new AR.Trackable2DObject(this.tracker, "*", {
			drawables: {
				cam: [this.modelCar, buttonRotate,pageOneButton1, pageOneButton2, pageOneButton3, pageOneButton4, pageOneButton5, pageOneButton6]
			},
