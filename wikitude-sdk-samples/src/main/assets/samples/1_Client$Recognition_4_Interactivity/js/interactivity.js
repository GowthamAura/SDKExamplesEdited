var World = {
	...
	createOverlays: function createOverlaysFn() {
		...
		*/
		...
		var video = new AR.VideoDrawable("assets/logo_promo.mp4", 0.5, {
        			offsetY: 0.09,
        			offsetX: -0.49
        		});
...
this.imgButton = new AR.ImageResource("assets/webview.png");
var pageOneButton1 = this.createWwwButton("http://www.auraaz.com", 0.08, {
			offsetX: 0.10,
			offsetY: -0.20,
			zOrder: 1
		});
		this.imgButton = new AR.ImageResource("assets/fb.png");
        var pageOneButton2 = this.createWwwButton("https://www.facebook.com/auraaz.connect", 0.1, {
        			offsetX: 0.50,
        			offsetY: -0.20,
        			zOrder: 1
        		});
        		this.imgButton = new AR.ImageResource("assets/youtubeicon.png");
                        var pageOneButton3 = this.createWwwButton("https://www.youtube.com/watch?v=nPeJPztBAos", 0.1, {
                        			offsetX: 0.80,
                        			offsetY: -0.20,
                        			zOrder: 1
                        		});/*
		...
		*/
		var trackable = new AR.Trackable2DObject(this.tracker, "*", {
			drawables: {
				cam: [this.modelCar, buttonRotate,pageOneButton1, pageOneButton2,pageOneButton3, video]
			},
